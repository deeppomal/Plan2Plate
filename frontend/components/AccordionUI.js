  ...
  return (
    <>
      <div
        ...
        className="flex group cursor-pointer w-3/4 mx-auto h-16 justify-between  items-center p-2 mt-2 rounded-md bg-white hover:bg-rose-800 hover:shadow-lg focus:bg-rose-800 "
      >
        <div className="flex group cursor-pointer">
          <div className="text-rose-600 font-semibold pl-10 group-hover:text-white">
            {title}
          </div>
        </div>
